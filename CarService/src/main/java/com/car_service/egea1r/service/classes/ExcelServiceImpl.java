...
public class ExcelServiceImpl implements ExcelService {
    ...
    @Async
    public CompletableFuture<List<ExcelCarDTO>> excelToCarDTO() throws IOException {
        String sheetString = "Munka1";
        ...
        try {
            ...
            while (rows.hasNext()) {
                ...
                while (cellsInRow.hasNext()) {
                    ...
                    setExcelCarDTO(cellIdx, currentCell, excelCarDTO);
                    cellIdx++;
                }
    ...
    private void setExcelCarDTO(int cellIdx, Cell currentCell, ExcelCarDTO excelCarDTO){
        switch (cellIdx) {
            case 0:
